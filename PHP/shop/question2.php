...
<body>
    ...
    <form action="question3.php" method="POST">
        ...
        <div class="laukas">
            ...
            <p class="questions">Kaip vertinate prekės kokybę?</p>

            <input type="radio" id="mark1" name="question2" value="1">
            <label for="mark1">Blogai</label>
            <input type="radio" id="mark2" name="question2" value="2">
            <label for="mark2">Patenkinimai</label>
            <input type="radio" id="mark3" name="question1" value="3">
            <label for="mark3">Vidutiniškai</label>
            <input type="radio" id="mark4" name="question2" value="4">
            <label for="mark4">Gerai</label>
            <input type="radio" id="mark5" name="question2" value="5">
